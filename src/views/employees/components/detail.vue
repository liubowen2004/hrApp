<template>
	<div>
		<div class="box">
			<el-form ref="unst" :model="unst" label-width="80px">
				<div class="top">
					<div class="zuo">
  			  ...
  			  <el-input v-model="unst.workNumber"></el-input>
  				  ...
  				  <el-input v-model="unst.mobile" style="width: 400px;"></el-input>
  				</el-form-item>
				...
				<div class="you">
					<el-form-item label="入职时间">
 					   <el-col :span="11">
 					     <el-date-picker type="date" placeholder="选择日期" v-model="unst.timeOfEntry" style="width: 100%;"></el-date-picker>
 					   </el-col>
 					 </el-form-item>
		...
		<div class="bun">
			<el-form ref="unst" :model="unst" label-width="120px">
				...
				<el-form-item label="入党时间">
					<el-col :span="11">
 					     <el-date-picker type="date" placeholder="选择日期" v-model="form.timeToJoinTheParty" style="width: 100%;"></el-date-picker>
 					   </el-col>
  			</el-form-item>
...
export default {
 ...
 methods: {
	...
	onSubmit(){
		userbaoAPI(this.unst).then(res=>{
			console.log(res,'更改');
		})
	},
	onSubmit1(){
		personabaoAPI(this.form).then(res=>{
			console.log(res);
		})
	},
	async getEmployeeRoleDetail() {
      let res = await API.getEmployeeRoleDetailApi({ id: this.id })
      this.unst=res.data
	  console.log(this.unst);
    }
 },
 created() {
