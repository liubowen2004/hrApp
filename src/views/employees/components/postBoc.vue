        ...
        <el-form-item label="首次合同开始时间">
          <el-col :span="11">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="form.initialContractStartTime"
              style="width: 100%"
            ></el-date-picker>
          </el-col>
        </el-form-item>
        <el-form-item label="首次合同结束时间">
          <el-col :span="11">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="form.firstContractTerminationTime"
              style="width: 100%"
            ></el-date-picker>
          </el-col>
        </el-form-item>
        <el-form-item label="现合同开始时间">
          <el-col :span="11">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="form.currentContractStartTime"
              style="width: 100%"
            ></el-date-picker>
          </el-col>
        </el-form-item>
        <el-form-item label="现合同结束时间">
          <el-col :span="11">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="form.closingTimeOfCurrentContract"
              style="width: 100%"
            ></el-date-picker>
          </el-col>
        </el-form-item>
...
export default {
  ...
  methods: {
    onSubmit() {
      jobsAPI(this.form).then((res) => {
        console.log(res, "岗位更改")
      })
    },
